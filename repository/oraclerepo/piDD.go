...
func (m *OracleDBRepo) GetPiDDByParams(ctx context.Context, arg models.ListPiDDParams) ([]*models.PiDD, int, error) {
...
func (m *OracleDBRepo) GetPiDDByParamsByPage(ctx context.Context, arg models.ListPiDDParamsByPage) ([]*models.PiDD, int, error) {
